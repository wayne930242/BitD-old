...
暗夜冷鋒（Blades in the Dark）的[系統參照文件（SRD）](https://github.com/amazingrando/blades-in-the-dark-srd-content)由 One Seven Design 以[創用 CC-BY](http://creativecommons.org/licenses/by/3.0/) 授權釋出。
...
<img src="/forged_in_the_dark_logo2_0.png" />
